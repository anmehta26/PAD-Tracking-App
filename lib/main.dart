...
class MyApp extends StatelessWidget {
  ...
  static const String _title = 'PAD App'; // private instance variable _title

  @override
  Widget build(BuildContext context) {
    return const MaterialApp(
      title:
          _title, // title property of the MaterialApp() widget, defines the title of the app
      home: MyStatefulWidget(),
      debugShowCheckedModeBanner: false,
    );
  } // this is the build widget. this is the start to the app
}
